Shader "Custom/AudioLinkOutput"
{
	//PASS 1: Regular AudioLink Output
	//  0, 0 -> 127, 3
	//	This should be: 
	//	R = G = B: Intensity of sound.
	//    Left-most pixel is current intensity.
	//    History goes right.
	//	A: 1.0
	//
	//PASS 2: Waveform output 
	//  0, 4 to 127, 9
	//	NOTE: Currently only MONO is supported.
	//   This reads left to right, for first 128 samples
	//   then top-to-bottom for subsequent groups of 128 bytes.
	//   only 768 samples are supported in this implementation.
	//  R = Left
	//	G = Right
	//  B = Mono channel
	//	A = 1.0.
	...
	//
	//PASS 4: ColorChord Colors (Just map here if you want a color for your thing and don't want any advanced effects)
	// 0, 11 to 127, 11
